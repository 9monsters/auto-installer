...
setupFile=/mnt/autotestsvr/Document/ServerTestFile/SetupFiles/db-4.7.25.tar.gz
...
mkdir -p "${setupDir}/dist/unix"
cd "${setupDir}/dist/unix"
make clean
# 预编译
