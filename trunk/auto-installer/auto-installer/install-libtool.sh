...
setupFile=/mnt/autotestsvr/Document/ServerTestFile/SetupFiles/libtool-1.5.22.tar.gz
...
# 将LIB加到添加文件中
echo "/usr/lib64/qt4/lib64" >/etc/ld.so.conf.d/qt4-x86_64.conf
echo "/usr/local/libtool/lib" >>/etc/ld.so.conf.d/qt4-x86_64.conf
